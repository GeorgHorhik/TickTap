const
    ...
    seearchBarButton = document.querySelector(".search__button"),
    tagsArea = document.querySelector(".existing-tags "),
    tagsAreaItem = document.querySelector("exiting-tags__item");
